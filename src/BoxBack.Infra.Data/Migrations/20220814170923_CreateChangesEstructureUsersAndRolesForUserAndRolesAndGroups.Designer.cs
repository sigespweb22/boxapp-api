...
namespace BoxBack.Infra.Data.Migrations
{
    ...
    [Migration("20220814170923_CreateChangesEstructureUsersAndRolesForUserAndRolesAndGroups")]
    partial class CreateChangesEstructureUsersAndRolesForUserAndRolesAndGroups
    {
            ...
            modelBuilder.Entity("BoxBack.Domain.Models.ApplicationGroup", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2022, 8, 14, 14, 9, 23, 78, DateTimeKind.Unspecified).AddTicks(6903), new TimeSpan(0, -3, 0, 0, 0)),
                            ...
                            UpdatedAt = new DateTimeOffset(new DateTime(2022, 8, 14, 14, 9, 23, 78, DateTimeKind.Unspecified).AddTicks(6916), new TimeSpan(0, -3, 0, 0, 0)),
            ...
            modelBuilder.Entity("BoxBack.Domain.Models.Tenant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2022, 8, 14, 14, 9, 23, 77, DateTimeKind.Unspecified).AddTicks(2655), new TimeSpan(0, -3, 0, 0, 0)),
                            CreatedBy = "8e445865-a24d-4543-a6c6-9443d048cdb9",
                            EmailPrincipal = "rafale@boxtecnologia.com.br",
                            IsDeleted = false,
                            Nome = "Box Tecnologia Ltda",
                            NomeExibicao = "Box Tecnologia",
                            UpdatedAt = new DateTimeOffset(new DateTime(2022, 8, 14, 14, 9, 23, 77, DateTimeKind.Unspecified).AddTicks(2684), new TimeSpan(0, -3, 0, 0, 0)),
                            UpdatedBy = "8e445865-a24d-4543-a6c6-9443d048cdb9"
                        });
                });
