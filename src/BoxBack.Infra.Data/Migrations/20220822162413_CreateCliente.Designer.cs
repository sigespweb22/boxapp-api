...
namespace BoxBack.Infra.Data.Migrations
{
    ...
    [Migration("20220822162413_CreateCliente")]
            ...
            modelBuilder.Entity("BoxBack.Domain.Models.ApplicationGroup", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2022, 8, 22, 13, 24, 13, 384, DateTimeKind.Unspecified).AddTicks(4378), new TimeSpan(0, -3, 0, 0, 0)),
                            ...
                            UpdatedAt = new DateTimeOffset(new DateTime(2022, 8, 22, 13, 24, 13, 384, DateTimeKind.Unspecified).AddTicks(4393), new TimeSpan(0, -3, 0, 0, 0)),
            ...
            modelBuilder.Entity("BoxBack.Domain.Models.Tenant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2022, 8, 22, 13, 24, 13, 382, DateTimeKind.Unspecified).AddTicks(7414), new TimeSpan(0, -3, 0, 0, 0)),
                            CreatedBy = "8e445865-a24d-4543-a6c6-9443d048cdb9",
                            EmailPrincipal = "rafale@boxtecnologia.com.br",
                            IsDeleted = false,
                            Nome = "Box Tecnologia Ltda",
                            NomeExibicao = "Box Tecnologia",
                            UpdatedAt = new DateTimeOffset(new DateTime(2022, 8, 22, 13, 24, 13, 382, DateTimeKind.Unspecified).AddTicks(7439), new TimeSpan(0, -3, 0, 0, 0)),
                            UpdatedBy = "8e445865-a24d-4543-a6c6-9443d048cdb9"
                        });
                });
