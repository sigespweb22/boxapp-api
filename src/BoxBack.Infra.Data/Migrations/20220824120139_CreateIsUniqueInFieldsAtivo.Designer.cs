...
namespace BoxBack.Infra.Data.Migrations
{
    ...
    [Migration("20220824120139_CreateIsUniqueInFieldsAtivo")]
    partial class CreateIsUniqueInFieldsAtivo
    {
            ...
            modelBuilder.Entity("BoxBack.Domain.Models.ApplicationGroup", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2022, 8, 24, 9, 1, 38, 967, DateTimeKind.Unspecified).AddTicks(1957), new TimeSpan(0, -3, 0, 0, 0)),
                            ...
                            UpdatedAt = new DateTimeOffset(new DateTime(2022, 8, 24, 9, 1, 38, 967, DateTimeKind.Unspecified).AddTicks(1971), new TimeSpan(0, -3, 0, 0, 0)),
            ...
            modelBuilder.Entity("BoxBack.Domain.Models.Tenant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2022, 8, 24, 9, 1, 38, 965, DateTimeKind.Unspecified).AddTicks(5595), new TimeSpan(0, -3, 0, 0, 0)),
                            CreatedBy = "8e445865-a24d-4543-a6c6-9443d048cdb9",
                            EmailPrincipal = "rafale@boxtecnologia.com.br",
                            IsDeleted = false,
                            Nome = "Box Tecnologia Ltda",
                            NomeExibicao = "Box Tecnologia",
                            UpdatedAt = new DateTimeOffset(new DateTime(2022, 8, 24, 9, 1, 38, 965, DateTimeKind.Unspecified).AddTicks(5618), new TimeSpan(0, -3, 0, 0, 0)),
                            UpdatedBy = "8e445865-a24d-4543-a6c6-9443d048cdb9"
                        });
                });
