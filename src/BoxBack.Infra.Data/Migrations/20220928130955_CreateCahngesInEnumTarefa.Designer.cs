...
namespace BoxBack.Infra.Data.Migrations
{
    ...
    [Migration("20220928130955_CreateCahngesInEnumTarefa")]
    partial class CreateCahngesInEnumTarefa
    {
            ...
            modelBuilder.Entity("BoxBack.Domain.Models.ApplicationGroup", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2022, 9, 28, 10, 9, 54, 411, DateTimeKind.Unspecified).AddTicks(7230), new TimeSpan(0, -3, 0, 0, 0)),
                            ...
                            UpdatedAt = new DateTimeOffset(new DateTime(2022, 9, 28, 10, 9, 54, 411, DateTimeKind.Unspecified).AddTicks(7240), new TimeSpan(0, -3, 0, 0, 0)),
            ...
            modelBuilder.Entity("BoxBack.Domain.Models.Tenant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2022, 9, 28, 10, 9, 54, 409, DateTimeKind.Unspecified).AddTicks(6714), new TimeSpan(0, -3, 0, 0, 0)),
                            CreatedBy = "8e445865-a24d-4543-a6c6-9443d048cdb9",
                            EmailPrincipal = "rafale@boxtecnologia.com.br",
                            IsDeleted = false,
                            Nome = "Box Tecnologia Ltda",
                            NomeExibicao = "Box Tecnologia",
                            UpdatedAt = new DateTimeOffset(new DateTime(2022, 9, 28, 10, 9, 54, 409, DateTimeKind.Unspecified).AddTicks(6738), new TimeSpan(0, -3, 0, 0, 0)),
                            UpdatedBy = "8e445865-a24d-4543-a6c6-9443d048cdb9"
                        });
                });
