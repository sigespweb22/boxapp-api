...
namespace BoxBack.Infra.Data.Migrations
{
    ...
    [Migration("20221011235803_CreateRefactoringFornecedorClienteServicos")]
    partial class CreateRefactoringFornecedorClienteServicos
    {
            ...
            modelBuilder.Entity("BoxBack.Domain.Models.ApplicationGroup", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2022, 10, 11, 20, 58, 2, 591, DateTimeKind.Unspecified).AddTicks(6482), new TimeSpan(0, -3, 0, 0, 0)),
                            ...
                            UpdatedAt = new DateTimeOffset(new DateTime(2022, 10, 11, 20, 58, 2, 591, DateTimeKind.Unspecified).AddTicks(6491), new TimeSpan(0, -3, 0, 0, 0)),
            ...
            modelBuilder.Entity("BoxBack.Domain.Models.Tenant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2022, 10, 11, 20, 58, 2, 589, DateTimeKind.Unspecified).AddTicks(7928), new TimeSpan(0, -3, 0, 0, 0)),
                            CreatedBy = "8e445865-a24d-4543-a6c6-9443d048cdb9",
                            EmailPrincipal = "rafale@boxtecnologia.com.br",
                            IsDeleted = false,
                            Nome = "Box Tecnologia Ltda",
                            NomeExibicao = "Box Tecnologia",
                            UpdatedAt = new DateTimeOffset(new DateTime(2022, 10, 11, 20, 58, 2, 589, DateTimeKind.Unspecified).AddTicks(7951), new TimeSpan(0, -3, 0, 0, 0)),
                            UpdatedBy = "8e445865-a24d-4543-a6c6-9443d048cdb9"
                        });
                });
