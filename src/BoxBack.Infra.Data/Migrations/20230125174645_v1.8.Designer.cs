            ...
            modelBuilder.Entity("BoxBack.Domain.Models.Rotina", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b0c60d41-7b31-4e02-ab9e-ad2c9e351443"),
                            ChaveSequencial = 8,
                            CreatedAt = new DateTimeOffset(new DateTime(2023, 1, 25, 14, 46, 45, 103, DateTimeKind.Unspecified).AddTicks(1182), new TimeSpan(0, -3, 0, 0, 0)),
                            ...
                            UpdatedAt = new DateTimeOffset(new DateTime(2023, 1, 25, 14, 46, 45, 103, DateTimeKind.Unspecified).AddTicks(1205), new TimeSpan(0, -3, 0, 0, 0)),
