...
namespace BoxBack.Infra.Data.Migrations
{
    ...
    [Migration("20221101131803_CreateChangesInClienteServicoMap")]
    partial class CreateChangesInClienteServicoMap
    {
            ...
            modelBuilder.Entity("BoxBack.Domain.Models.ApplicationGroup", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2022, 11, 1, 10, 18, 2, 589, DateTimeKind.Unspecified).AddTicks(7772), new TimeSpan(0, -3, 0, 0, 0)),
                            ...
                            UpdatedAt = new DateTimeOffset(new DateTime(2022, 11, 1, 10, 18, 2, 589, DateTimeKind.Unspecified).AddTicks(7797), new TimeSpan(0, -3, 0, 0, 0)),
            ...
            modelBuilder.Entity("BoxBack.Domain.Models.Tenant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2022, 11, 1, 10, 18, 2, 579, DateTimeKind.Unspecified).AddTicks(4786), new TimeSpan(0, -3, 0, 0, 0)),
                            CreatedBy = "8e445865-a24d-4543-a6c6-9443d048cdb9",
                            EmailPrincipal = "rafale@boxtecnologia.com.br",
                            IsDeleted = false,
                            Nome = "Box Tecnologia Ltda",
                            NomeExibicao = "Box Tecnologia",
                            UpdatedAt = new DateTimeOffset(new DateTime(2022, 11, 1, 10, 18, 2, 579, DateTimeKind.Unspecified).AddTicks(4813), new TimeSpan(0, -3, 0, 0, 0)),
                            UpdatedBy = "8e445865-a24d-4543-a6c6-9443d048cdb9"
                        });
                });
