...
namespace BoxBack.Infra.Data.Migrations
{
    ...
    [Migration("20220926173754_CreatePipelineAndAllReferences")]
    partial class CreatePipelineAndAllReferences
    {
            ...
            modelBuilder.Entity("BoxBack.Domain.Models.ApplicationGroup", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2022, 9, 26, 14, 37, 54, 60, DateTimeKind.Unspecified).AddTicks(991), new TimeSpan(0, -3, 0, 0, 0)),
                            ...
                            UpdatedAt = new DateTimeOffset(new DateTime(2022, 9, 26, 14, 37, 54, 60, DateTimeKind.Unspecified).AddTicks(1003), new TimeSpan(0, -3, 0, 0, 0)),
            ...
            modelBuilder.Entity("BoxBack.Domain.Models.Tenant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2022, 9, 26, 14, 37, 54, 57, DateTimeKind.Unspecified).AddTicks(9643), new TimeSpan(0, -3, 0, 0, 0)),
                            CreatedBy = "8e445865-a24d-4543-a6c6-9443d048cdb9",
                            EmailPrincipal = "rafale@boxtecnologia.com.br",
                            IsDeleted = false,
                            Nome = "Box Tecnologia Ltda",
                            NomeExibicao = "Box Tecnologia",
                            UpdatedAt = new DateTimeOffset(new DateTime(2022, 9, 26, 14, 37, 54, 57, DateTimeKind.Unspecified).AddTicks(9666), new TimeSpan(0, -3, 0, 0, 0)),
                            UpdatedBy = "8e445865-a24d-4543-a6c6-9443d048cdb9"
                        });
                });
