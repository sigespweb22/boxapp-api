...
namespace BoxBack.Infra.Data.Migrations
{
    ...
    [Migration("20221106145330_CreateChangesInApplicationUserMap")]
    partial class CreateChangesInApplicationUserMap
    {
            ...
            modelBuilder.Entity("BoxBack.Domain.Models.ApplicationGroup", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2022, 11, 6, 11, 53, 30, 28, DateTimeKind.Unspecified).AddTicks(6144), new TimeSpan(0, -3, 0, 0, 0)),
                            ...
                            UpdatedAt = new DateTimeOffset(new DateTime(2022, 11, 6, 11, 53, 30, 28, DateTimeKind.Unspecified).AddTicks(6161), new TimeSpan(0, -3, 0, 0, 0)),
            ...
            modelBuilder.Entity("BoxBack.Domain.Models.Tenant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2022, 11, 6, 11, 53, 30, 26, DateTimeKind.Unspecified).AddTicks(4826), new TimeSpan(0, -3, 0, 0, 0)),
                            CreatedBy = "8e445865-a24d-4543-a6c6-9443d048cdb9",
                            EmailPrincipal = "rafale@boxtecnologia.com.br",
                            IsDeleted = false,
                            Nome = "Box Tecnologia Ltda",
                            NomeExibicao = "Box Tecnologia",
                            UpdatedAt = new DateTimeOffset(new DateTime(2022, 11, 6, 11, 53, 30, 26, DateTimeKind.Unspecified).AddTicks(4851), new TimeSpan(0, -3, 0, 0, 0)),
                            UpdatedBy = "8e445865-a24d-4543-a6c6-9443d048cdb9"
                        });
                });
