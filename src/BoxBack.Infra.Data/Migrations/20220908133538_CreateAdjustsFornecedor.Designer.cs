...
namespace BoxBack.Infra.Data.Migrations
{
    ...
    [Migration("20220908133538_CreateAdjustsFornecedor")]
    partial class CreateAdjustsFornecedor
    {
            ...
            modelBuilder.Entity("BoxBack.Domain.Models.ApplicationGroup", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2022, 9, 8, 10, 35, 37, 951, DateTimeKind.Unspecified).AddTicks(2084), new TimeSpan(0, -3, 0, 0, 0)),
                            ...
                            UpdatedAt = new DateTimeOffset(new DateTime(2022, 9, 8, 10, 35, 37, 951, DateTimeKind.Unspecified).AddTicks(2104), new TimeSpan(0, -3, 0, 0, 0)),
            ...
            modelBuilder.Entity("BoxBack.Domain.Models.Tenant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2022, 9, 8, 10, 35, 37, 949, DateTimeKind.Unspecified).AddTicks(2747), new TimeSpan(0, -3, 0, 0, 0)),
                            CreatedBy = "8e445865-a24d-4543-a6c6-9443d048cdb9",
                            EmailPrincipal = "rafale@boxtecnologia.com.br",
                            IsDeleted = false,
                            Nome = "Box Tecnologia Ltda",
                            NomeExibicao = "Box Tecnologia",
                            UpdatedAt = new DateTimeOffset(new DateTime(2022, 9, 8, 10, 35, 37, 949, DateTimeKind.Unspecified).AddTicks(2780), new TimeSpan(0, -3, 0, 0, 0)),
                            UpdatedBy = "8e445865-a24d-4543-a6c6-9443d048cdb9"
                        });
                });
