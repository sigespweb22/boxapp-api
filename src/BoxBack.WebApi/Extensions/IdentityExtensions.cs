...
namespace BoxBack.WebApi.Extensions
{
    public static class IdentityExtensions
    {
        ...
        [DebuggerStepThrough]
        public static async Task<IdentityResult> UpdateAsync<T>(this BoxAppDbContext context, T model, string id) where T : class
        {
        ...
        [DebuggerStepThrough]
        public static async Task<IdentityResult> DeleteAsync<T>(this BoxAppDbContext context, string id) where T : class
        {
            var entity = await context.FindAsync<T>(id);
